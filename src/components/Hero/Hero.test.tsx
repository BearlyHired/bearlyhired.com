...
describe('Hero', () => {
  ...
  it('should render the subtitle', () => {
    ...
    expect(screen.getByText('features.welcome.hero.subtitle')).toBeInTheDocument();
  });
  ...
  it('should render the description', () => {
    ...
    expect(screen.getByText('features.welcome.hero.description')).toBeInTheDocument();
  });
  ...
  it('should render Join the Waitlist button', () => {
    ...
    expect(screen.getByRole('button', { name: 'features.welcome.hero.joinWaitlist' })).toBeInTheDocument();
  });
  ...
  it('should render Learn More button', () => {
    ...
    expect(screen.getByRole('button', { name: 'features.welcome.hero.learnMore' })).toBeInTheDocument();
  });
  ...
  it('should call onJoinWaitlist when Join the Waitlist button is clicked', async () => {
    ...
    await user.click(screen.getByRole('button', { name: 'features.welcome.hero.joinWaitlist' }));
  ...
  it('should call onLearnMore when Learn More button is clicked', async () => {
    ...
    await user.click(screen.getByRole('button', { name: 'features.welcome.hero.learnMore' }));
